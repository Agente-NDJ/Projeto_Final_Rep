                ...
                <div data-thq="thq-mobile-menu" class="register-mobile-menu">
                    <div class="register-nav">
                        <div class="register-top">
                            <img alt="image" src="https://presentation-website-assets.teleporthq.io/logos/logo.png" class="register-logo" />
                        ...
                        <nav class="register-links1">
                            <span class="register-text4">About</span>
                            <span class="register-text5">Features</span>
                            <span class="register-text6">Pricing</span>
                            <span class="register-text7">Team</span>
                            <span class="register-text8">Blog</span>
                        </nav>
                    ...
                    <div>
                        ...
                        <svg viewBox="0 0 877.7142857142857 1024" class="register-icon06">
                        ...
                        <svg viewBox="0 0 602.2582857142856 1024" class="register-icon08">
